...
public class AndroidUtils {
                        ...
                        DialogUtils.showCustomAlertDialog(
                                ...
                                new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        if (com.lupinemoon.favicoin.presentation.utils.AndroidUtils.isPackageInstalled(
                                                activity,
    ...
    public static String getDeviceId(Context context) {
        ...
        if (TextUtils.isEmpty(deviceId)) {
            deviceId = com.lupinemoon.favicoin.presentation.utils.AndroidUtils.getSecureDeviceId(context);
            if (TextUtils.isEmpty(deviceId)) {
