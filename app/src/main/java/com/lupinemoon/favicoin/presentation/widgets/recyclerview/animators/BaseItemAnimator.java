package com.lupinemoon.favicoin.presentation.widgets.recyclerview.animators;
...
import com.lupinemoon.favicoin.presentation.widgets.recyclerview.internal.ViewHelper;
...
public abstract class BaseItemAnimator extends SimpleItemAnimator {
    ...
    private void animateMoveImpl(final ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        ...
        // FutureTODO: make EndActions end listeners instead, since end actions aren't called when
    ...
    public void endAnimation(ViewHolder item) {
        ...
        // FutureTODO if some other animations are chained to end, how do we cancel them as well?
