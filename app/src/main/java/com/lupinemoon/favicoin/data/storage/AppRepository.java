...
public class AppRepository implements AppDataStore {
    ...
    public String getAuthString(Context context) {
        AuthToken authToken = (AuthToken) MainApplication.getStorage(context).getObject(com.lupinemoon.favicoin.presentation.utils.Constants.KEY_AUTH_TOKEN, AuthToken.class);
        if (authToken != null) {
